...
import numpy as np
import settings
from archived2.utils.geometry_utils import get_middle_point_index
from archived2.utils.segmentation_utils import get_index_of_x_extremum_in_contours, get_index_of_y_maximum_in_contours, \
