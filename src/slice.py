...
from utils.image_utils import merge_left_right_images, get_z_value, get_non_margin_row_index
import pydicom as dicom


def handle_lung_slice(image_basename: str):
    ...
    margin_start_index = get_non_margin_row_index(color_image, 0, 1)
    margin_stop_index = get_non_margin_row_index(color_image, settings.image_height - 1, -1)

    return margin_start_index, margin_stop_index
